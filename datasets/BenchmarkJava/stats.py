...
def plot_coverity_defects():
    ...
    fig.suptitle(f'Coverity benchmark against BenchmarkJava dataset ({unique_correct_number} unique correct analysis over {testcode_number} test codes)', fontsize=16)
