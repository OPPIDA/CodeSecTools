...
CLITemplate.add_benchmark(cli, Analyzer, help="""Benchmark Coverity on a dataset""")

CLITemplate.add_import(
    cli, RESULT_DIR, Analyzer, help="""Import existing Coverity analysis results"""
)
...
## Stats
CLITemplate.add_stats(cli, "coverity", Analyzer, help="""Display benchmark stats""")
