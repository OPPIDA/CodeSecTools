...
class Graphics:
    def __init__(self, sast: SAST, project_name: str):
        self.sast = sast
...
class FileDatasetGraphics(ProjectGraphics):
    def __init__(self, sast: SAST, dataset: FileDataset):
...
class GitRepoDatasetGraphics(Graphics):
    def __init__(self, sast: SAST, dataset: GitRepoDataset):
        super().__init__(sast=sast, project_name=dataset.full_name)
        self.dataset = dataset
