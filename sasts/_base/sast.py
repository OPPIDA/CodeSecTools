...
from datasets._base.dataset import Dataset, FileDataset, GitRepoDataset
from sasts._base.parser import AnalysisResult
from utils import MissingFile, NonZeroExit, run_command
...
class SAST:
    ...
    def run_analysis(self, lang: str, project_dir: str, result_dir: str) -> None:
        ...
        extra = {"logs": command_output, "duration": end - start}
